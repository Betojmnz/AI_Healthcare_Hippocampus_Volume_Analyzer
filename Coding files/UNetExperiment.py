...
class UNetExperiment:
    ...
    def train(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            data = batch['image']
            target = batch['seg']
            data, target = ((Variable(data).to(self.device, dtype=torch.float)), Variable(target).to(self.device))
            ...
            # ANSWER: They represent: 1st - batch index, 2nd - No. of channel output, 3rd and 4th - y and z pixels.
